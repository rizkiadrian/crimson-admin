    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 flex flex-col md:ml-64 min-h-screen">
        ...
        <div className="flex-1 bg-white relative">
          ...
          <main className="w-full h-full bg-[#F8F9FA] md:rounded-tl-[50px] border-t border-l border-neutral-200/60 p-4 md:p-12 overflow-y-auto shadow-[inset_10px_10px_30px_-15px_rgba(0,0,0,0.03)]">
