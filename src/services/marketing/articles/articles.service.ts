...
export const articlesService = {
  list: async (
    ...
    return await api.get("/marketing/articles", { params });
  },

  detail: async (id: number): Promise<IApiResponse<IArticle>> => {
    return await api.get(`/marketing/articles/${id}`);
  },

  create: async (data: FormData | object): Promise<IApiResponse<IArticle>> => {
    return await api.post("/marketing/articles", data);
  },
  ...
  update: async (
    ...
    return await api.post(`/marketing/articles/${id}`, data);
  },

  delete: async (id: number): Promise<IApiResponse<null>> => {
    return await api.delete(`/marketing/articles/${id}`);
  },

  publish: async (id: number): Promise<IApiResponse<IArticle>> => {
    return await api.patch(`/marketing/articles/${id}/publish`);
  },

  unpublish: async (id: number): Promise<IApiResponse<IArticle>> => {
    return await api.patch(`/marketing/articles/${id}/unpublish`);
  },

  archive: async (id: number): Promise<IApiResponse<IArticle>> => {
    return await api.patch(`/marketing/articles/${id}/archive`);
  },
  ...
  schedule: async (
    ...
    return await api.patch(`/marketing/articles/${id}/schedule`, payload);
  },

  uploadImage: async (file: File): Promise<IApiResponse<{ url: string }>> => {
    const formData = new FormData();
    formData.append("image", file);
    return await api.post("/marketing/articles/upload-image", formData);
  },
};
